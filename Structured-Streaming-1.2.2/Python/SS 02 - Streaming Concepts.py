...
# MAGIC     var allHints = document.getElementsByClassName("hint-6317");
# MAGIC     var answer = document.getElementById("answer-6317");
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-6317");
...
# MAGIC           id="hint-button-6317">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-6317" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
